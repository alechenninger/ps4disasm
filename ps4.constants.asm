...
; Interaction_Object = ramaddr($FFFFF43A) ; try lower word at FFFFFFFA?
...
Extended_Event_Flags = ramaddr($FFFFF120)
Chest_Flags = ramaddr($FFFFF140)
Temp_Event_Flags = ramaddr($FFFFF156)
